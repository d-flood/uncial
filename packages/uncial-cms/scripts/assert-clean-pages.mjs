// Asserts the zero-CMS-JS guarantee (PRD §3) against the built demo site:
// no content-page HTML file — nor any JS chunk it references, transitively —
// may contain the runtime sentinel, while every /edit/ page must.
